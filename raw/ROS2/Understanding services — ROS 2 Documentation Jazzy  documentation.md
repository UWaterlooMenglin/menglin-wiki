...
---
---
title: "Understanding services — ROS 2 Documentation: Jazzy  documentation"
...
tags:
  - "clippings"
---
**You're reading the documentation for an older, but still supported, version of ROS 2. For information on the latest version, please have a look at [Lyrical](https://docs.ros.org/en/lyrical/Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Services/Understanding-ROS2-Services.html).**
...
![../../../_images/Service-SingleServiceClient.gif](https://docs.ros.org/en/jazzy/_images/Service-SingleServiceClient.gif) ![../../../_images/Service-MultipleServiceClient.gif](https://docs.ros.org/en/jazzy/_images/Service-MultipleServiceClient.gif)

## Prerequisites

Some concepts mentioned in this tutorial, like [Nodes](https://docs.ros.org/en/jazzy/Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Nodes/Understanding-ROS2-Nodes.html) and [Topics](https://docs.ros.org/en/jazzy/Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Topics/Understanding-ROS2-Topics.html), were covered in previous tutorials in the series.

You will need the [turtlesim package](https://docs.ros.org/en/jazzy/Tutorials/Beginner-CLI-Tools/Introducing-Turtlesim/Introducing-Turtlesim.html).
...
![../../../_images/clear.png](https://docs.ros.org/en/jazzy/_images/clear.png)
...
![../../../_images/spawn1.png](https://docs.ros.org/en/jazzy/_images/spawn1.png)
