---
title: "Configuration (config.json) — Onshape to robot latest documentation"
source: "https://onshape-to-robot.readthedocs.io/en/latest/config.html"
author:
published:
created: 2026-06-11
description:
