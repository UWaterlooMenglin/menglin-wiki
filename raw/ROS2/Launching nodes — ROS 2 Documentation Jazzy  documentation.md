---
title: "Launching nodes — ROS 2 Documentation: Jazzy  documentation"
...
tags:
  - "clippings"
---
**You're reading the documentation for an older, but still supported, version of ROS 2. For information on the latest version, please have a look at [Lyrical](https://docs.ros.org/en/lyrical/Tutorials/Beginner-CLI-Tools/Launching-Multiple-Nodes/Launching-Multiple-Nodes.html).**
...
Before starting these tutorials, install ROS 2 by following the instructions on the ROS 2 [Installation](https://docs.ros.org/en/jazzy/Installation.html) page.
...
> [!note] Note
> The launch file above is written in Python, but you can also use XML and YAML to create launch files. You can see a comparison of these different ROS 2 launch formats in [Using XML, YAML, and Python for ROS 2 Launch Files](https://docs.ros.org/en/jazzy/How-To-Guides/Launch-file-different-formats.html).

This will run two turtlesim nodes:

![../../../_images/turtlesim_multisim.png](https://docs.ros.org/en/jazzy/_images/turtlesim_multisim.png)

For now, don’t worry about the contents of this launch file. You can find more information on ROS 2 launch in the [ROS 2 launch tutorials](https://docs.ros.org/en/jazzy/Tutorials/Intermediate/Launch/Launch-Main.html).
...
![../../../_images/turtlesim_multisim_spin.png](https://docs.ros.org/en/jazzy/_images/turtlesim_multisim_spin.png)
