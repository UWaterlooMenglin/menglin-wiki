---
title: "Using rqt_console to view logs — ROS 2 Documentation: Jazzy  documentation"
...
tags:
  - "clippings"
---
**You're reading the documentation for an older, but still supported, version of ROS 2. For information on the latest version, please have a look at [Lyrical](https://docs.ros.org/en/lyrical/Tutorials/Beginner-CLI-Tools/Using-Rqt-Console/Using-Rqt-Console.html).**
...
You will need [rqt\_console and turtlesim](https://docs.ros.org/en/jazzy/Tutorials/Beginner-CLI-Tools/Introducing-Turtlesim/Introducing-Turtlesim.html) installed.
...
![../../../_images/console.png](https://docs.ros.org/en/jazzy/_images/console.png)
...
To produce log messages for `rqt_console` to display, let’s have the turtle run into the wall. In a new terminal, enter the `ros2 topic pub` command (discussed in detail in the [topics tutorial](https://docs.ros.org/en/jazzy/Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Topics/Understanding-ROS2-Topics.html)) below:
...
![../../../_images/warn.png](https://docs.ros.org/en/jazzy/_images/warn.png)
