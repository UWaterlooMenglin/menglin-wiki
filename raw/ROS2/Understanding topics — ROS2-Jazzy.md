...
---
---
title: "Understanding topics — ROS 2 Documentation: Jazzy  documentation"
...
tags:
  - "clippings"
---
**You're reading the documentation for an older, but still supported, version of ROS 2. For information on the latest version, please have a look at [Lyrical](https://docs.ros.org/en/lyrical/Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Topics/Understanding-ROS2-Topics.html).**
...
![../../../_images/Topic-SinglePublisherandSingleSubscriber.gif](https://docs.ros.org/en/jazzy/_images/Topic-SinglePublisherandSingleSubscriber.gif)

A node may publish data to any number of topics and simultaneously have subscriptions to any number of topics.

![../../../_images/Topic-MultiplePublisherandMultipleSubscriber.gif](https://docs.ros.org/en/jazzy/_images/Topic-MultiplePublisherandMultipleSubscriber.gif)

Topics are one of the main ways in which data is moved between nodes and therefore between different parts of the system.

## Prerequisites

The [previous tutorial](https://docs.ros.org/en/jazzy/Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Nodes/Understanding-ROS2-Nodes.html) provides some useful background information on nodes that is built upon here.
...
Recall from the [previous tutorial](https://docs.ros.org/en/jazzy/Tutorials/Beginner-CLI-Tools/Understanding-ROS2-Nodes/Understanding-ROS2-Nodes.html) that the names of these nodes are `/turtlesim` and `/teleop_turtle` by default.
...
The [turtlesim tutorial](https://docs.ros.org/en/jazzy/Tutorials/Beginner-CLI-Tools/Introducing-Turtlesim/Introducing-Turtlesim.html) tells you how to install rqt and all its plugins, including `rqt_graph`.
...
![../../../_images/rqt_graph.png](https://docs.ros.org/en/jazzy/_images/rqt_graph.png)
...
rqt\_graph is a graphical introspection tool. Now we’ll look at some command line tools for introspecting topics.
...
![../../../_images/unhide.png](https://docs.ros.org/en/jazzy/_images/unhide.png)
...
![../../../_images/debug.png](https://docs.ros.org/en/jazzy/_images/debug.png)
...
There are four main ways to use the `pub` command as shown below. However, the autocomplete feature described in `c.` and `d.` is not supported in Windows.
...
> ```
> 
> This will publish the default values for the message type at 1 Hz. In this case, this equivalent to the following command:
> 
> ```
...
> 
> This is because the terminal does not recognize the single quote as part of the autocomplete string. Hence it needs to be escaped by using `\'` to be recognized as part of the string.
> 
...
The turtle (and commonly the real robots which it is meant to emulate) require a steady stream of commands to operate continuously. So, to get the turtle moving, and keep it moving, you can use the following dictionary string:

```
$ ros2 topic pub /turtle1/cmd_vel geometry_msgs/msg/Twist "{linear: {x: 2.0, y: 0.0, z: 0.0}, angular: {x: 0.0, y: 0.0, z: 1.8}}"
```

![../../../_images/pub_stream.png](https://docs.ros.org/en/jazzy/_images/pub_stream.png)
...
![../../../_images/pub_once.png](https://docs.ros.org/en/jazzy/_images/pub_once.png)

You can refresh rqt\_graph to see what’s happening graphically. You will see that the `ros2 topic pub ...` node (`/_ros2cli_30358`) is publishing over the `/turtle1/cmd_vel` topic, which is being received by both the `ros2 topic echo ...` node (`/_ros2cli_26646`) and the `/turtlesim` node now.

![../../../_images/rqt_graph2.png](https://docs.ros.org/en/jazzy/_images/rqt_graph2.png)
...
![../../../_images/rqt_graph3.png](https://docs.ros.org/en/jazzy/_images/rqt_graph3.png)
